...
// convert Time object to string(yyyy/MM/dd HH:mm:ss.SSS)
func ConvertTimeToFileLogerFormatString(time time.Time) string {
	return time.Local().Format("2006-01-02 15:04:05.999999")
}
