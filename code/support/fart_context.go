...
func (this *FartContext) GetSessionCache() *cache.Table {
	return this.SessionCache
}

func (this *FartContext) GetControllerMap() map[string]core.Controller {
	return this.ControllerMap
}

func (this *FartContext) Cleanup() {
...
func (this *FartContext) ServeHTTP(writer http.ResponseWriter, request *http.Request) {
	this.Router.ServeHTTP(writer, request)
}

func (this *FartContext) OpenDb() {
	...
	if core.CONFIG.DbType() == "sqlite" {
		...
		var err error = nil
		this.db, err = gorm.Open(sqlite.Open(core.CONFIG.SqliteFolder()+"/fart.sqlite"), &gorm.Config{Logger: dbLogger, NamingStrategy: namingStrategy})
...
func (this *FartContext) registerBean(bean core.Bean) {
...
func (this *FartContext) GetBean(bean core.Bean) core.Bean {
...
func (this *FartContext) InstallOk() {
