...
type FartConfig struct {
	...
	// sqlite file path
	sqliteFolder string
	// configs in fart.json
	item *ConfigItem
}

// fart.json config items.
...
// whether installed.
func (this *FartConfig) Installed() bool {
	return this.installed
}

// server port
func (this *FartConfig) ServerPort() int {
	return this.serverPort
}

// get the db type
func (this *FartConfig) DbType() string {
	return this.item.DbType
}

// mysql url
func (this *FartConfig) MysqlUrl() string {
	return this.mysqlUrl
}

// get the sqlite path
func (this *FartConfig) SqliteFolder() string {
...
// matter path
func (this *FartConfig) MatterPath() string {
	return this.matterPath
}

// matter path
func (this *FartConfig) NamingStrategy() schema.NamingStrategy {
...
func (this *FartConfig) FinishInstall(dbType string, mysqlPort int, mysqlHost string, mysqlSchema string, mysqlUsername string, mysqlPassword string, mysqlCharset string) {
	...
	// Write to fart.json (cannot use os.O_APPEND  or append)
	filePath := util.GetConfPath() + "/fart.json"
