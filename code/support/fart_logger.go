...
func (this *FartLogger) Destroy() {
	this.closeFile()
}

// uniform log method
func (this *FartLogger) Log(prefix string, format string, v ...interface{}) {
...
func (this *FartLogger) Debug(format string, v ...interface{}) {
	this.Log("[DEBUG]", format, v...)
}

func (this *FartLogger) Info(format string, v ...interface{}) {
	this.Log("[INFO ]", format, v...)
}

func (this *FartLogger) Warn(format string, v ...interface{}) {
	this.Log("[WARN ]", format, v...)
}

func (this *FartLogger) Error(format string, v ...interface{}) {
	this.Log("[ERROR]", format, v...)
}

func (this *FartLogger) Panic(format string, v ...interface{}) {
...
func (this *FartLogger) maintain() {
	...
	destPath := util.GetLogPath() + "/fart-" + util.ConvertTimeToDateString(util.Yesterday()) + ".log"
...
// log file name
func (this *FartLogger) fileName() string {
	return util.GetLogPath() + "/fart.log"
}

// open log file
func (this *FartLogger) openFile() {
...
// close log file.
func (this *FartLogger) closeFile() {
	if this.file != nil {
		err := this.file.Close()
		if err != nil {
